...
using ChinookMusicStore.Models.AccountViewModels;
using ChinookMusicStore.Services;
...
namespace ChinookMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string returnUrl = null)
        {
            ...
            ViewData["CreateAccount"] = _localizer["CreateAccount"];
            ViewData["Email"] = _localizer["Email"];
            ViewData["Password"] = _localizer["Password"];
            ViewData["ForgotPassword"] = _localizer["ForgotPassword"];
            ViewData["RegisterNew"] = _localizer["RegisterNew"];
            ViewData["LocalAcount"] = _localizer["LocalAcount"];
